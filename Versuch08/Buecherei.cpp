...
// Vorwörtsdeklarationen aller vorhandenen Funktionen
...
int main()
{
    // Vektor mit allen Medien der Böcherei
    ...
    // Pröfen, ob Unterklassen schon programmiert wurden (siehe bedingtes Kompilieren)
    // entsprechend wird die Datenbank mit unterschiedlichen Medien geföllt
    fuelleDatenbank(medien);

    char abfrage;
    do  // Anzeige des Menös
    {
        std::cout << std::endl
                  << "Menue:" << std::endl
                  << "-----------------------------" << std::endl
        ...
        switch (abfrage)
        {
            ...
            /////////////////////////////////////////////
            // Ein Medium wird zur Datenbank hinzufögt //
            /////////////////////////////////////////////
            case '1':
            {
            ...
            ////////////////////////////////////////
            // Medium an die Böcherei zuröckgeben //
            ////////////////////////////////////////
            case '5':
            {
            ...
            case '7':
            {
                std::cout << "Das Menö wird nun beendet." << std::endl;
                break;
            }
    ...
    // Beim Beenden des Programms sömtliche Medien löschen
...
/////////////////////////////////////////////////////////////
// Definition aller Vorwörtsdeklarierten Funktionen
...
#if UNTERKLASSENVORHANDEN
    {
        // Datenbank wird mit Medien geföllt
...
void mediumHinzufuegen(std::vector<Medium*>& medien)
{
    #if UNTERKLASSENVORHANDEN
    {
        ...
        // öber std::cin.ignore(10,\n) wird die "Enter-Eingabe, die för std::cin benötigt wird ignoriert
        // Ansonsten wörde der nöchste getline Befehl nicht auf eine Eingabe warten...
        char abfrage;
        std::cin >> abfrage;
        std::cin.ignore(10,'\n');
        ...
        switch (abfrage)
        {
            ...
            case '2':
            {
                ...
                // Einlesen des Datums (siehe öberladener Eingabeoperator in der Klasse Datum)
                Datum datumAusgabe;
            ...
            /*case '4':
            {
                std::cout << "Geben Sie den Titel des Mediums ein: " << std::endl;
                std::string titel;
                getline(std::cin, titel);
            ...
            // Ungöltige Eingabe
            default:
                std::cout << "Ungöltige Eingabe!" << std::endl;
                break;
        }
    }
...
void mediumEntfernen(std::vector<Medium*>& medien)
{
    ...
    if(!success)
    {
        std::cout << "Keine göltige ID!" << std::endl;
    }
}
...
void mediumAusleihen(std::vector<Medium*>& medien, Datum aktuellesDatum)
{
    // Einlesen der ID (öber std::cin.ignore(10, '\n'), wird die
...
void alleMedienAusgeben(std::vector<Medium*>& medien)
{
    std::cout << "Vorhandene Medien in der Böcherei:" << std::endl;
...
////////////////////////////////////////////////////////////
// Funktion gibt ausgeliehene Medien in der Datenbank aus //
////////////////////////////////////////////////////////////
void ausgelieheneMedienAusgeben(std::vector<Medium*>& medien)
{
    std::cout << "Ausgeliehene Medien:" << std::endl;
    bool nichtsAusgeliehen = true;
    for (unsigned int index = 0; index < medien.size(); index++)
    {
        if (medien[index]->getStatus())
        {
            nichtsAusgeliehen = false;
            std::cout << "*************************************************************" << std::endl;
            std::cout << *medien[index];
        }
    }
    if (nichtsAusgeliehen)
    {
